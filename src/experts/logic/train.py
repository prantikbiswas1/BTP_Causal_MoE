...
DATA_PATH = "/home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/data/experts/logic/logic_train_exploded.jsonl"
OUTPUT_DIR = "/home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/models/experts/logic_expert_qwen_7b"
...
def train():
    ...
    def tokenize_func(example):
        try:
            ...
            cleaned_step = clean_logic(example["logic_step"])

            # Ensure format
            if not cleaned_step.startswith("[LOGIC]"):
                cleaned_step = f"[LOGIC] {cleaned_step}"

            # Filter weak samples
            if len(cleaned_step.split()) < 2:
                return None

            # ✅ Use EOS instead of custom token
    ...
    print(f"🚀 Training Logic Expert (steps={TARGET_STEPS})")
    ...
    print("💾 Logic expert saved correctly.")
