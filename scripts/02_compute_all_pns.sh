...
echo "--------------------------------------------------------"
echo "Scoring PNS for GSM-8k (Test Set)..."
python /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/src/pns_engine/run_pns_engine_batched.py \
    --model /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/models/Qwen2.5-7B-Instruct \
    --input /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/data/processed/gsm8k_test_traces.jsonl \
    --output /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/data/pns_scored/gsm8k_test_scored.jsonl

echo "--------------------------------------------------------"
echo "Scoring PNS for CommonsenseQA (Validation Set)..."
python /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/src/pns_engine/run_pns_engine_batched.py \
    --model /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/models/Qwen2.5-7B-Instruct \
    --input /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/data/processed/commonsense_qa_val_traces.jsonl \
    --output /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/data/pns_scored/commonsense_qa_val_scored.jsonl
