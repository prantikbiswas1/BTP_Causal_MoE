...
echo "--------------------------------------------------------"
echo "Generating evaluation traces for GSM-8k (Test Set)..."
python /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/src/data_prep/generator.py \
    --model /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/models/Qwen2.5-7B-Instruct \
    --dataset /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/data/raw/gsm8k_test.jsonl \
    --output /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/data/processed/gsm8k_test_traces.jsonl \
    --k 5 --temp 0.7

echo "--------------------------------------------------------"
echo "Generating evaluation traces for CommonsenseQA (Validation Set)..."
python /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/src/data_prep/generator.py \
    --model /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/models/Qwen2.5-7B-Instruct \
    --dataset /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/data/raw/commonsense_qa_val.jsonl \
    --output /home/rupeshk_iitp/Prantik/BTP/BTP_Causal_MoE/data/processed/commonsense_qa_val_traces.jsonl \
    --k 5 --temp 0.7
